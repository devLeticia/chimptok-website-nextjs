...
export default function StepTwo () {
    return (
      ...
      <div className='flex flex-col gap-6'>
        ...
        <h1 className="font-barlow text-5xl text-black font-black leading-none uppercase">Use Time Tracker  <br className='hidden md:flex'/>for Daily Consistency</h1>
      ...
      <div className="relative flex flex-col items-center justify-center bg-zinc-100 shadow-2xl rounded-2xl  border border-1 border-gray-300 px-6 pt-24 md:px-16">
