    ...
    return (
        ...
        >
          ...
          <div className="flex flex-col items-center justify-center gap-3 ">
            ...
            <button onClick={openSignUp} className="mt-6 font-extrabold text-black bg-gradient-to-r from-yellow-200 to-yellow-500 hover:from-yellow-200 hover:to-yellow-300 border border-1 border-yellow-400 py-4 px-6 w-full rounded-md shadow-lg">START NOW</button>
          </div>
